    ...
    <div className="flex flex-col items-center gap-2">
      <div style={{ perspective: "1200px" }}>
        ...
        >
          {/* ── FRONT FACE ── */}
          <motion.div
            className="absolute inset-0 w-full h-full rounded-2xl border p-4 sm:p-6 flex flex-col justify-between shadow-2xl overflow-hidden bg-black/90 border-white/10 backdrop-blur-xl"
            style={{
          ...
          >
            {/* Glow blobs */}
            <div
              className="absolute top-0 right-0 w-36 h-36 bg-[#0066b3]/15 rounded-full blur-[60px] -mr-16 -mt-16 transition-all duration-700"
              style={{ opacity: isHovered ? 0.4 : 0.15 }}
            />
            <div
              className="absolute bottom-0 left-0 w-28 h-28 bg-[#cb000e]/10 rounded-full blur-[50px] -ml-12 -mb-12 transition-all duration-700"
          ...
          {/* ── BACK FACE ── */}
          <motion.div
            className="absolute inset-0 w-full h-full rounded-2xl border p-4 sm:p-6 flex flex-col justify-center shadow-2xl overflow-hidden bg-zinc-900 border-white/10"
            style={{
              backfaceVisibility: "hidden",
              WebkitBackfaceVisibility: "hidden",
